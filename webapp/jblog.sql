...
--------------------------------------------------------
  ...
  ALTER TABLE "JBLOG"."POST" MODIFY ("POSTTILE" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "JBLOG"."COMMENTS" ADD CONSTRAINT "P_COMMENTS_FK" FOREIGN KEY ("POSTNO")
